...
// Load data
 $departments = $conn->query("SELECT d.*, (SELECT COUNT(*) FROM doctors WHERE department_id = d.id AND status = 1) as doctor_count FROM departments d ORDER BY name ASC");
 $doctors = $conn->query("
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <button type="submit" class="inline-flex mt-4 items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-custom-500 hover:bg-custom-600 rounded-md transition-colors">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" class="space-y-3">
                            ...
                            <button type="submit" class="w-full mt-4  inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-custom-500 hover:bg-custom-600 rounded-md transition-colors">
                    ...
                    <div class="card-body">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-3 p-3 rounded-md border border-slate-200 dark:border-zink-600 <?= $dept['status'] != 1 ? 'opacity-50' : '' ?>">
                                ...
                                <a href="history.php?dept_id=<?= $dept['id'] ?>">
                                <button class="w-full mt-1  inline-flex items-center justify-center gap-2 px-3 py-1.5 text-sm font-medium text-white bg-custom-500 hover:bg-custom-600 rounded-md transition-colors">
